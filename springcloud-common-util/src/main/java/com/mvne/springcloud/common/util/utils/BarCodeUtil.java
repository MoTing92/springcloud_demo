...
//    	String contents = "asdfghjklzxc";
//		int width = 20;
//		int height = 80;
//		BufferedImage barCode = encodeBarcode(contents, width, height);
//		System.out.println(barCode.toString());
    	String content = decodeBarcode("src/main/resources/img/barcode3.gif");
    ...
    public static BufferedImage encodeQRcode(String context,int width,int height){
        ...
        try {
            ...
            Logger.getLogger(BarCodeUtil.class.getName()).log(Level.SEVERE, null, ex);
        }
        return qrCode;
    }
